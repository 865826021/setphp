...
<div class="head">
<div class="pubw">
<div class="a">SETPHP后台管理系统 version2.0</div>
<div class="b">
...
<div class="left">
	<ul id="ula">
	<li><a id="first">SETPHP控制台</a></li>
	<li><a>基本</a>
	<ul id="ulb" style=" display:none;">
		<li><a href="#" class="hoverchild">基本设置</a></li>
		</ul>
	</li>
...
<div class="right">
	...
	<ul>
	<li><a href="#">首页</a></li>
	<li class="active">&gt;&nbsp;SETPHP控制台</li></ul>
	</div>
	
	<div class="content">
	<div class="message">欢迎您使用SETPHP后台管理系统，基于SMT引擎</div>
	<div>
<!--服务器相关参数-->
